...
<body>
  <div class="main">
    ...
    <div class="intro">
      <img
        src="images/Pritom_Banik_CSE2.jpg"
        alt="Profile Picture"
        class="profile-pic" />
      <div class="name">
      ...
      <div class="about">
        ...
        <div class="socialMedia">
          <a href="https://github.com/UnpolishedNoob" target="_blank"><img src="images/github.png" alt="GitHub Logo" class="social-icon" /></a>
          <a
            href="https://www.linkedin.com/in/pritom-banik-272828250/"
            target="_blank"><img src="images/linkedin.png" alt="LinkedIn Logo" class="social-icon" /></a>
          <a href="https://discord.com/users/1062709844311801886" target="_blank"><img src="images/discord.png" alt="Discord Logo" class="social-icon" /></a>
          ...
          <a href="mailto:banikpritom321@gmail.com"><img src="images/email.png" alt="Email Logo" class="social-icon" /></a>
        </div>
      </div>
    </div>
    ...
    <div class="all">
      ...
      <div id="topNavBar" class="navigationBar">
        ...
        <a href="resume.php" class="nav-item active">Resume</a>
      ...
      <div class="bottom-navigationBar">
        ...
        <a href="resume.php" class="b-nav-item active">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="resume">
        ...
        <div class="section">
          <div
            ...
            onclick="toggleWork('all-work','arrow-icon-work')">
            <span>Work Experience</span>
            <i class="fa-solid fa-chevron-down" id="arrow-icon-work"></i>
          </div>
          ...
          <div class="section-content" id="all-work">
        ...
        <div class="section">
          <div
            class="section-header"
            onclick="toggleWork('all-education','arrow-icon-education')">
            <span>Education</span>
            <i class="fa-solid fa-chevron-down" id="arrow-icon-education"></i>
          </div>
          ...
          <div class="section-content hidden" id="all-education">
        ...
        <div class="section">
          <div
            class="section-header"
            onclick="toggleWork('all-skill','arrow-icon-skill')">
            <span>Skills</span>
            <i class="fa-solid fa-chevron-down" id="arrow-icon-skill"></i>
          </div>
          <div class="section-content hidden" id="all-skill"></div>
        </div>
        ...
        <div class="section">
          <div
            class="section-header"
            onclick="toggleWork('all-interest','arrow-icon-interest')">
            <span>Interests</span>
            <i class="fa-solid fa-chevron-down" id="arrow-icon-interest"></i>
          </div>
          <div class="section-content hidden" id="all-interest"></div>
        </div>
      </div>
    </div>
  </div>
