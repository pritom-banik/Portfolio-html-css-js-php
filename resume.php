  ...
  <div class="main">
    ...
    <div class="all">
      ...
      <div class="resume">
        ...
        <!-- Education -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-education','arrow-icon-education')">
            <span>Education</span>
        ...
        <!-- Skills -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-skill','arrow-icon-skill')">
            <span>Skills</span>
        ...
        <!-- Interests -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-interest','arrow-icon-interest')">
            <span>Interests</span>
