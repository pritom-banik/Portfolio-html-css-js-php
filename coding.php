  ...
  <div class="main">
    ...
    <div class="all">
      ...
      <div class="full">
        <!-- Problem Solving -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-problem-solving', 'arrow-icon-problem-solving','.txt')">
        ...
        <!-- Coding Skills -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-coding-skill', 'arrow-icon-coding-skill','.txt')">
        ...
        <!-- GitHub Repo -->
        <div class="section">
          <div class="section-header" onclick="toggleWork('all-github-repo', 'arrow-icon-github-repo','.txt')">
          ...
          <div id="all-github-repo" class="section-gitrepo hidden grid "></div>
        </div>
      </div>
    </div>
  </div>
