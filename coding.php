    ...
    <div class="main">
      ...
      <div class="all">
        ...
        <div id="topNavBar" class="navigationBar">
          ...
          <a href="coding.php" class="nav-item active">Coding</a>
      ...
      V86.044h53.398c6.012,0,10.925-4.848,10.925-10.925V21.721h179.2c5.301,0,9.632,4.331,9.632,9.632V116.816z"
          ...
          <a href="coding.php" class="b-nav-item active">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              class="icon"
        ...
        <div class="full">
          ...
          <div class="section">
            <div
              ...
              onclick="toggleWork('all-problem-solving', 'arrow-icon-problem-solving','.txt')"
            >
              <span>Problem-Solving</span>
              <svg id="arrow-icon-problem-solving" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
            ...
            <div id="all-problem-solving" class="section-body"></div>
          </div>
          ...
          <div class="section">
            <div
              class="section-header"
              onclick="toggleWork('all-coding-skill', 'arrow-icon-coding-skill','.txt')"
            >
              <span>Coding Skills</span>
              <svg id="arrow-icon-coding-skill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
            ...
            <div id="all-coding-skill" class="section-body hidden"></div>
          </div>
          ...
          <div class="section">
            <div
              class="section-header"
              onclick="toggleWork('all-github-repo', 'arrow-icon-github-repo','.txt')"
            >
              <span>Github Repo</span>
              <svg id="arrow-icon-github-repo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <path
                  d="M297.4 438.6C309.9 451.1 330.2 451.1 342.7 438.6L502.7 278.6C515.2 266.1 515.2 245.8 502.7 233.3C490.2 220.8 469.9 220.8 457.4 233.3L320 370.7L182.6 233.4C170.1 220.9 149.8 220.9 137.3 233.4C124.8 245.9 124.8 266.2 137.3 278.7L297.3 438.7z"
                />
              </svg>
            </div>
            <div id="all-github-repo" class="section-body hidden grid"></div>
          </div>
        </div>
      </div>
    </div>
